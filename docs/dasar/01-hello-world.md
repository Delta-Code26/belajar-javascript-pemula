Oke Marno, siap tempur! Berikut isi lengkap dan interaktif untuk file `01-hello-world.md`, siap ditempatkan di folder `D:\dokumentasi\javascript\belajar-javascript-pemula\docs\dasar\` 🚀
